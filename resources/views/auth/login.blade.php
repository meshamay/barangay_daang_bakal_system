...
<body class="relative overflow-hidden min-h-screen flex items-center justify-center p-0 sm:p-0 bg-gradient-to-br from-blue-50 via-white to-blue-100 overflow-y-hidden">
