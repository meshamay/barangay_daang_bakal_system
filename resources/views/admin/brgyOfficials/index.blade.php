                        ...
                        <td class="py-5 px-6 text-center">
                            <div class="flex justify-center items-center gap-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <span class="absolute top-full mt-2 left-1/2 -translate-x-1/2 px-2 py-1 text-xs text-white bg-gray-900 rounded whitespace-nowrap opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-200 z-50">View Official</span>
                                </div>
                                ...
                                <div class="relative group">
                                    ...
                                    <span class="absolute top-full mt-2 left-1/2 -translate-x-1/2 px-2 py-1 text-xs text-white bg-gray-900 rounded whitespace-nowrap opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-200 z-50">Edit Official</span>
                                </div>
                                ...
                                <div class="relative group">
                                    ...
                                    <span class="absolute top-full mt-2 left-1/2 -translate-x-1/2 px-2 py-1 text-xs text-white bg-gray-900 rounded whitespace-nowrap opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-200 z-50">Delete Official</span>
                                </div>
                            </div>
                        </td>
                    </tr>
