        ...
        <table class="w-full text-sm" style="font-family: 'Poppins', sans-serif;">
            <thead style="background: linear-gradient(135deg, #134573 0%, #0d2d47 100%); color: white; position: sticky; top: 0; z-index: 10; font-size: 14px;" class="shadow-sm">
                <tr class="text-[14px] font-semibold uppercase tracking-widest text-center">
                    ...
                    <th class="py-5 px-6" style="font-family: 'Poppins', sans-serif;">Date Registered</th>
                    <th class="py-5 px-6" style="font-family: 'Poppins', sans-serif;">Status</th>
                    <th class="py-5 px-6" style="font-family: 'Poppins', sans-serif;">Action</th>
				</tr>
			</thead>
			<tbody class="divide-y divide-gray-100">
				...
				@empty
               <tr>
                    <td colspan="7" class="h-[574px] p-0 text-center text-gray-400 text-sm align-middle">
...
<div id="addStaffModal" class="modal-container hidden fixed top-[80px] left-[240px] w-[calc(100vw-240px)] h-[calc(100vh-80px)] flex items-center justify-center z-[9999]">
    <div class="bg-white w-[700px] rounded-3xl shadow-2xl overflow-hidden border-2 border-gray-100">
        <div class="px-6 py-4 flex items-center gap-3" style="background: linear-gradient(135deg, #134573 0%, #0d2d47 100%);">
            <h2 class="text-white font-bold text-xl tracking-wide" style="font-family: 'Poppins', sans-serif;">Add New Staff</h2>
        </div>
        <div class="p-8">
            <form action="{{ route('admin.staffs.store') }}" method="POST" novalidate>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="last_name" class="w-full rounded-lg border border-gray-300 px-3 py-2.5 bg-gray-50 text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent" style="font-family: 'Poppins', sans-serif;" required>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2" style="font-family: 'Poppins', sans-serif;">First Name:</label>
                        <input type="text" name="first_name" class="w-full rounded-lg border border-gray-300 px-3 py-2.5 bg-gray-50 text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent" style="font-family: 'Poppins', sans-serif;" required>
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2" style="font-family: 'Poppins', sans-serif;">User Name:</label>
                        <input type="text" name="username" class="w-full rounded-lg border border-gray-300 px-3 py-2.5 bg-gray-50 text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent" style="font-family: 'Poppins', sans-serif;" required>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2" style="font-family: 'Poppins', sans-serif;">Email:</label>
                        <input type="email" name="email" class="w-full rounded-lg border border-gray-300 px-3 py-2.5 bg-gray-50 text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent" style="font-family: 'Poppins', sans-serif;" required>
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" id="addPassword" name="password" class="w-full border-2 border-gray-300 rounded-xl px-4 py-3 pr-12 bg-gray-50 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" style="font-family: 'Poppins', sans-serif;" required>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" id="addPasswordConfirmation" name="password_confirmation" class="w-full border-2 border-gray-300 rounded-xl px-4 py-3 pr-12 bg-gray-50 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" style="font-family: 'Poppins', sans-serif;" required>
    ...
    <div class="bg-white w-[650px] rounded-3xl shadow-2xl overflow-hidden border-2 border-gray-100">
        ...
        <div class="p-8">
            <div class="grid grid-cols-2 gap-5 mb-4">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2" style="font-family: 'Poppins', sans-serif;">Last Name:</label>
                    <input type="text" id="viewLastName" readonly class="w-full rounded-lg border border-gray-300 px-3 py-2.5 bg-gray-50 text-gray-700" style="font-family: 'Poppins', sans-serif;">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2" style="font-family: 'Poppins', sans-serif;">First Name:</label>
                    <input type="text" id="viewFirstName" readonly class="w-full rounded-lg border border-gray-300 px-3 py-2.5 bg-gray-50 text-gray-700" style="font-family: 'Poppins', sans-serif;">
                </div>
            </div>
            <div class="grid grid-cols-2 gap-5 mb-4">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2" style="font-family: 'Poppins', sans-serif;">User Name:</label>
                    <input type="text" id="viewUsername" readonly class="w-full rounded-lg border border-gray-300 px-3 py-2.5 bg-gray-50 text-gray-700" style="font-family: 'Poppins', sans-serif;">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2" style="font-family: 'Poppins', sans-serif;">Password:</label>
                    <div class="relative">
                        <input type="password" id="viewPassword" readonly class="w-full border-2 border-gray-300 rounded-xl px-4 py-3 pr-12 bg-gray-50 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" style="font-family: 'Poppins', sans-serif;" value="••••••••">
            ...
            <div class="grid grid-cols-2 gap-5 mb-8">
                <div>
                    ...
                    <input type="text" id="viewDateCreated" readonly class="w-full rounded-lg border border-gray-300 px-3 py-2.5 bg-gray-50 text-gray-700" style="font-family: 'Poppins', sans-serif;">
                </div>
            </div>
...
<div id="deleteModal" class="modal-container hidden fixed top-[80px] left-[240px] w-[calc(100vw-240px)] h-[calc(100vh-80px)] flex items-center justify-center z-[9999]">
    <div class="bg-white w-[520px] rounded-3xl shadow-2xl p-10 text-center border-2 border-gray-100 transform transition-all">
        ...
        <!-- Title -->
        <h2 class="font-bold text-2xl mb-4 text-gray-800 tracking-tight" style="font-family: 'Poppins', sans-serif;">Delete Staff Member</h2>
        ...
        <form id="deactivateForm" method="POST" action="">
            ...
            <div class="flex justify-center gap-4 mt-6">
                <button type="button" onclick="closeModal('deleteModal')" class="px-8 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl text-sm font-semibold transition-all duration-200 hover:shadow-md border border-gray-300" style="font-family: 'Poppins', sans-serif;">Cancel</button>
                <button type="submit" class="px-8 py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-xl text-sm font-semibold transition-all duration-200 hover:shadow-lg transform hover:scale-105" style="font-family: 'Poppins', sans-serif;">Delete Staff</button>
            </div>
        </form>
    </div>
</div>
