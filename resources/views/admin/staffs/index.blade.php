            ...
            <form action="{{ route('admin.staffs.store') }}" method="POST" novalidate>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div>
                        ...
                        <select name="role" class="w-full rounded-lg border border-gray-300 px-3 py-2.5 bg-gray-50 text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
