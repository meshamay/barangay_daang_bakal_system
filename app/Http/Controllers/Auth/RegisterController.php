...
class RegisterController extends Controller
{
    ...
    public function register(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'photo'          => 'required|file|mimes:jpeg,png,jpg,gif,webp,heic,heif|max:10240',
            ...
            'id_front'       => 'required|file|mimes:jpeg,png,jpg,gif,webp,heic,heif|max:10240',
            'id_back'        => 'required|file|mimes:jpeg,png,jpg,gif,webp,heic,heif|max:10240',
            ...
            'photo.mimes'           => '1x1 photo must be a JPG, PNG, GIF, WEBP, HEIC, or HEIF file.',
            'id_front.max'          => 'Front ID photo must not be greater than 10 MB.',
            'id_front.mimes'        => 'Front ID photo must be a JPG, PNG, GIF, WEBP, HEIC, or HEIF file.',
            'id_back.max'           => 'Back ID photo must not be greater than 10 MB.',
            'id_back.mimes'         => 'Back ID photo must be a JPG, PNG, GIF, WEBP, HEIC, or HEIF file.',
        ]);
